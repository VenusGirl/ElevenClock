...
lang_3_3 = {
    ...
    "Any text can be placed here. To place items such as date and time, please use the 1989 C standard. More info on the following link": "모든 텍스트를 여기에 배치할 수 있습니다. 날짜, 시간 등의 항목을 배치할 때는 1989년 C 표준을 사용하십시오. 다음 링크에 대해 자세히 알아보십시오",
